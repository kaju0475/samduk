...
const publicApiPaths = [
  ...
  '/api/auth/session',
  '/api/auth/logout',
  '/api/system/backup/now', // [CRITICAL] Allow backup cron to bypass cookie check (Auth handled in route)
  '/api/system/diag', // [DIAGNOSTIC] Allow system check without auth
];
